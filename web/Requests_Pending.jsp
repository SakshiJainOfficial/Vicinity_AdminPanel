...
<html>
    ...
    <body>
        ...
        <% ArrayList<ArrayList> Rows1 = (ArrayList<ArrayList>) request.getSession().getAttribute("requestPendingList");%>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <button type="submit" class="btn btn-danger" formaction="DeclineServlet" name="deleteId" value="<%= Rows1.get(i).get(0)%>">Decline</button> 
                </form>
            </div>
        </div>
        <%}%>
